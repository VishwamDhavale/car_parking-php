...
//todays Vehicle Entries
 $query=mysqli_query($con,"select bookid from book where date(timefrom)=CURDATE();");
...
//Yesterdays Vehicle Entrie
 $query1=mysqli_query($con,"select bookid from book where date(timefrom)=CURDATE()-1;");
...
//Last Sevendays Vehicle Entries
 $query2=mysqli_query($con,"select bookid from book where date(timefrom)>=(DATE(NOW()) - INTERVAL 7 DAY);");
...
//Total Vehicle Entries
 $query3=mysqli_query($con,"select bookid from book");
...
//total Registered Users
 $query=mysqli_query($con,"select userid from user");
