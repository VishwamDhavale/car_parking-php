            ...
            <div class="animated fadeIn">
                <div class="row">
                   ...
                   <th>Action</th>
                                           ...
                                           <?php
$ret=mysqli_query($con,"select *from  book");
$cnt=1;
...
?>
                ...
                <tr>
                  ...
                  <td><?php  echo $row['bookid'];?> <?php  echo $row['LastName'];?></td>
                  ...
                  <td><a href="admin-book-edit.php?bookid=<?php echo $row['bookid'];?>" class="btn btn-danger">Edit</a></td>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>    
