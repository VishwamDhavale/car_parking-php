...
?> 
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"> <input type="text" name="mobilenumber" maxlength="10" pattern="[6789][0-9]{9}" class="form-control" value="<?php  echo $row['mobileno'];?>"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="regdate" value="<?php  echo $row['usertype'];?>" class="form-control"></div>
                                    </div>
                                    <?php } ?>
