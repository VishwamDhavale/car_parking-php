...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update user set firstname='$fname', lastname='$lname', usertype='$usertype',mobileno='$mobileno' where userid='$uid'");
    if ($query) {
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                   ...
                                   <?php
$uid=$_SESSION['vpmsuid'];
$ret=mysqli_query($con,"select * from user where userid='$uid'");
$cnt=1;
...
?> 
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"> <input type="text" name="mobileno" maxlength="10" pattern="[0-9]{10}" class="form-control" value="<?php  echo $row['mobileno'];?>"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Email address</label></div>
                                        <div class="col-12 col-md-9"><input type="email" name="email" required="true" class="form-control" value="<?php  echo $row['email'];?>"></div>
                                    </div>
                                  
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">User Type</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="usertype" value="<?php  echo $row['usertype'];?>" class="form-control"></div>
                                    </div>
                                    <?php } ?>
