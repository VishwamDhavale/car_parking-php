...
if (strlen($_SESSION['vpmsuid']==0)) {
   ...
   if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "update user set firstname='$fname', lastname='$lname' where userid='$uid'");
    if ($query) {
...
?> 
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"> <input type="text" name="mobilenumber" maxlength="10" pattern="[0-9]{10}" readonly="true" class="form-control" value="<?php  echo $row['mobileno'];?>"></div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="disabled-input" class=" form-control-label">User Type</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="regdate" value="<?php  echo $row['usertype'];?>"  readonly="true" class="form-control"></div>
                                    </div>
                                    <?php } ?>
