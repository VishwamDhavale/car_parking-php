...
?>
                ...
                <tr>
                  ...
                  <td><a href="view.php?userid=<?php echo $user;?>&bookid=<?php echo $row['bookid'];?>&customerid=<?php echo $row['customerid'];?>&spaceid=<?php echo $row['spaceid'];?>" class="btn btn-primary">View</a> 
