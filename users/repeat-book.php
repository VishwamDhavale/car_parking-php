...
if(isset($_POST['submit']))
  {
    ...
    $check=mysqli_query($con,"select no_of_slots from space where spaceid='$cid'");
    $check_value=mysqli_fetch_array($check);
if($check_value>0){
    ...
    echo "<script>alert('Something Went Wrong/slot not available. Please try again.');</script>";
    }
            ...
            <div class="animated fadeIn">
              ...
              ?>    
                  ...
                  <?php } ?> 
                                    ...
                                    $timeto=$_GET['timeto'];
                                    $run=mysqli_query($con,"select *from customertb join book on customertb.customerid=book.customerid where customertb.customerid='$customerid'"); 
                                    while($row=mysqli_fetch_array($run)){
                                    ?>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">vehicale No  </label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="vehno" name="vehno" class="form-control" value="<?php echo $row['vehicleno']; ?>" required="true"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Driver Name</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="drivername" name="drivername" class="form-control" value="<?php echo $row['drivername']; ?>" required="true"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Driver Licence</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="licenceno" name="licenceno" class="form-control" value="<?php echo $row['licenceno']; ?>" required="true"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">From</label></div>
                                            <div class="col-12 col-md-9"><input type="datetime-local" id="from" name="from" class="form-control" value="<?php echo date('Y-m-d\TH:i',strtotime('+1 day',strtotime($timefrom))); ?>" required="true"></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">To</label></div>
                                            <div class="col-12 col-md-9"><input type="datetime-local" id="to" name="to" class="form-control" value="<?php echo date('Y-m-d\TH:i',strtotime('+1 day',strtotime($timefrom))); ?>" required="true" ></div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Vehicle Name</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="vehiclename" name="vehiclename" class="form-control" value="<?php echo $row['vehiclename']; ?>" required="true"></div>
                                        </div>
                                 <?php } ?>
