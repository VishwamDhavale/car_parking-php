...
if(isset($_POST['submit']))
  {
    ...
    $ret=mysqli_query($con, "select email from user where email='$email' || mobileno='$mobileno' || username='$username'");
    ...
    $query=mysqli_query($con, "insert into user(userid,username, password, usertype, firstname,lastname ,address,mobileno,email) value('$userid', '$username','$password', '$usertype', '$fname','$lname','$address','$mobileno','$email' )");
    if ($query) {
...
<head>
    ...
    <script src="admin/assets/css/bootstrap.min.css">
...
return true;
    ...
    <!-- <script type="text/javascript" src="https://cdn.jsdelivr.net/html5shiv/3.7.3/html5shiv.min.js"></scrip> -->
</head>
<body class="bg-dark">
                ...
                <div class="login-form">
                    <form method="post" onsubmit="return checkpass();">
                        ...
                        <div class="form-group">
                           ...
                           <input type="text" name="username" placeholder="Your User Name..." required="true" class="form-control">
                        </div>
                        <div class="form-group">
                      ...
                      <div class="form-group">
                           ...
                           <input type="text" name="usertype" placeholder="Renter/user" required="true" class="form-control">
                        </div>
                        <div class="form-group">
                            <label>Address</label>
                           <input type="text" name="address" placeholder="User address" required="true" class="form-control">
                        </div>                                               
                        <div class="form-group">
